    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
      <div class="card">
        <div class="card-header p-3 pt-2">
          ...
          <div class="text-end pt-1">
            <p class="text-sm mb-0 text-capitalize">Total d'employees</p>
            <h4 class="mb-0">{{ $user }}</h4>
          </div>
        </div>
        <hr class="dark horizontal my-0">
        <div class="card-footer p-3">
          <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+3% </span>du mois dernier</p>
        </div>
      </div>
    </div>
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                ...
                <tr>
                  ...
                  <td class="align-middle text-center">
                    @if ($last_entre->image != null)
                      <a href="{{ asset('uploards/'.$last_entre->image) }}" target="_blank"><img width="50px" height="50px" src="{{ asset('uploards/'.$last_entre->image) }}" alt=""></a>                                
                    @endif
                  </td>
                </tr>
                @endforeach
                ...
                <tr>
                  ...
                  <td class="align-middle text-center">
                    @if ($last_sorte->image != null)
                      <a href="{{ asset('uploards/'.$last_sorte->image) }}" target="_blank"><img width="50px" height="50px" src="{{ asset('uploards/'.$last_sorte->image) }}" alt=""></a>                                
                    @endif
                  </td>
                </tr>
                @endforeach
