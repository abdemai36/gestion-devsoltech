        ...
        <div class="card my-4">
          <div class="pe-md-3 d-flex align-items-center ">
            <div class="input-group input-group-outline mt-3 w-100 d-flex justify-content-between p-3">
              <h3>Gestion des archive d'entré</h3>
                <div class="cards2 w-100">
                  <form action="" class="cards">
                    ...
                    @if (Request::query('inputSearcharchive') || Request::query('dateDebut') || Request::query('dateFin'))
                      <a href="{{ route('admin.archive.entre') }}" class="btn btn-warning font-weight-bold text-xs badge h-100 text-center"> Annuler </a>
                    @endif
                    <form action="{{ route('archive.exportPDF.entre') }}" class="d-flex">
          ...
          <div class="card-body px-0 pb-2">
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0" id='table_archive'>
                ...
                <tbody>
                    @foreach ($archivesEntre as $archive)
                        <tr>
                            <td>
              ...
              {{ $archivesEntre->links('admin.layout.my_pagination') }}
            </div>
          </div>
        </div>
      </div>
...
@section('javascript_archive')
  <script>
    ...
    function archive_search()
    {
      ...
      window.location.href= "{{ route('admin.archive.entre') }}?"+$.param(query);
    }
