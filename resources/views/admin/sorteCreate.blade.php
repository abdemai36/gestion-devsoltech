                ...
                <div class="col-md-12 d-flex flex-column ">
                  <div class="card card-plain">
                    <div class="card-header">
                      <h4 class="font-weight-bolder">Ajouter un sorte</h4>
                      <p class="mb-0"></p>
                    </div>
                    <div class="card-body" style="background: white;border-radius: 0 0 0.75rem 0.75rem">
                      ...
                      @endif
                      <form role="form" method="POST" action="{{ route('admin.store.sorte') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-check form-check-info text-start ps-0">
                            ...
                            <textarea style="border: 1px solid #ddd" class="form-control" name="designiation" id="Désignation"></textarea> 
                        </div>
                        <div class="text-center">
                          <button type="submit" class="btn btn-lg btn-lg w-100 mt-4 mb-0 text-white" style="background: #00B1EB">Ajouter</button>
                        </div>
                      </form>
                    </div>
                  </div>
